...
{    
    material->SetDiffuseMap(L"Textures/Landscape/AWallTerrain.png");
    ...
    heightMap = Texture::Add(L"Textures/HeightMaps/AWallTerrainH4.png");
...
bool Terrain::ComputePicking(Vector3& pos)
{
    Ray ray = CAM->ScreenPointToRay(mousePos);
