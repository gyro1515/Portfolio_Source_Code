...
#include "C_TracerWidget.generated.h"
...
UCLASS()
class SERFPS_API UC_TracerWidget : public UUserWidget
{
	GENERATED_BODY()
private:
	// 아이콘 이미지
...
public:
	...
	void SetIconCoolTime(TSkillState skillState , bool _isCoolTime);
	void SetIconCoolTimeTmp(TSkillState skillState , float _tmpCoolTime);
