...
//영역
#include "C_GenjiSkill_LeftClick.generated.h"

UCLASS()
class AC_GenjiSkill_LeftClick : public AC_Skill
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AC_GenjiSkill_LeftClick();
...
public:
	...
	//void MulPlayMontage(UAnimMontage* MontageToPlay, float InPlayRate);
};
